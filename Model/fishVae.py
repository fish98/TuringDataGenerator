...
class VAE(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(inputDim, 600)
        self.fc21 = nn.Linear(600, latentDim)
        self.fc22 = nn.Linear(600, latentDim)
        self.fc3 = nn.Linear(latentDim, 600)
        self.fc4 = nn.Linear(600, inputDim)
        self.convertZ = nn.Linear(latentDim, 4)

    def encode(self, x):
        tmp1 = F.relu(self.fc1(x))
        return self.fc21(tmp1), self.fc22(tmp1)
    ...
    def decode(self, latent):
        tmp2 = F.relu(self.fc3(latent))
        return torch.sigmoid(self.fc4(tmp2))
